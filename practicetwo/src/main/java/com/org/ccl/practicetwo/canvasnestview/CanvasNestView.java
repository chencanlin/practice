...
public class CanvasNestView extends View implements Runnable {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCountPoint = typedArray.getInt(R.styleable.CanvasNestView_count_point, 60);
        mMaxDistance = typedArray.getInt(R.styleable.CanvasNestView_max_distance, 180);
